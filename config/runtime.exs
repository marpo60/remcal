...
#
#     PHX_SERVER=true bin/remcal start
#
...
if config_env() == :prod do
  database_path =
    System.get_env("DATABASE_PATH") ||
      ...
      For example: /etc/remcal/remcal.db
      """
  ...
  config :remcal, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
